            ...
            <div className="topNav">
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-6">
                            <Link to="/">
                                <img className="nav-logo" src="https://www2.arccorp.com/globalassets/arc-logos/corporate-logos/arc-logo-l-black.png" alt="ARC Logo" />
                            </Link>
                        </div>
                        <div className="col-6 nav-grip">
